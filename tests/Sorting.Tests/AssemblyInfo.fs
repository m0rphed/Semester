...
[<assembly: AssemblyTitleAttribute("Sorting.Tests")>]
[<assembly: AssemblyProductAttribute("Sorting")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Sorting.Tests"
    let [<Literal>] AssemblyProduct = "Sorting"
