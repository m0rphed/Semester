...
[<assembly: AssemblyTitleAttribute("BoolMrtx.Tests")>]
[<assembly: AssemblyProductAttribute("BoolMrtx")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "BoolMrtx.Tests"
    let [<Literal>] AssemblyProduct = "BoolMrtx"
