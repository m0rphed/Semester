...
[<assembly: AssemblyTitleAttribute("myList.Tests")>]
[<assembly: AssemblyProductAttribute("myList")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "myList.Tests"
    let [<Literal>] AssemblyProduct = "myList"
