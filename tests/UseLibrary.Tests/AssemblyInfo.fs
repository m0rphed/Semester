...
[<assembly: AssemblyTitleAttribute("UsesLibrary.Tests")>]
[<assembly: AssemblyProductAttribute("UsesLibrary")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "UsesLibrary.Tests"
    let [<Literal>] AssemblyProduct = "UsesLibrary"
