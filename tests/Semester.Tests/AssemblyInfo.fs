...
[<assembly: AssemblyTitleAttribute("Semester.Tests")>]
[<assembly: AssemblyProductAttribute("Semester")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Semester.Tests"
    let [<Literal>] AssemblyProduct = "Semester"
