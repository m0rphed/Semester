...
[<assembly: AssemblyTitleAttribute("UseLibrary")>]
[<assembly: AssemblyProductAttribute("UseLibrary")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "UseLibrary"
    let [<Literal>] AssemblyProduct = "UseLibrary"
