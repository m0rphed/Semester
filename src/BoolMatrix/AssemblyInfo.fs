...
[<assembly: AssemblyTitleAttribute("BoolMatrix")>]
[<assembly: AssemblyProductAttribute("BoolMatrix")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "BoolMatrix"
    let [<Literal>] AssemblyProduct = "BoolMatrix"
